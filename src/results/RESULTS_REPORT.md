...
| TC-CUR-11 | `data["units"]` | `agent.py:81` (inflate) | `agent.py:128` c-use (CONVERT\_DONE) | L81→L83→L85→L128 | units=10, BL\_RATE\_MANIPULATION | ~9 | **9** ¹ | **90** ² (FAIL) | **20, 10, 10** ³ (FAIL) | FAIL in B2 and B3 | **Group 1** — LKW catches BL\_RATE\_MANIPULATION |
